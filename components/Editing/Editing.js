...
import { SafeAreaView, ScrollView, View, TextInput, Keyboard } from 'react-native';
        ...
        <SafeAreaView style={styles.safeAreaView}>
            <View style={styles.header}>
                <Button
                    ...
                    onPress={() => saveList()}
                />
                <Text category='h6' style={styles.text}>Edit {title}</Text>
            </View>
            <TextInput
                value={name}
                style={styles.input}
